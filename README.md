...
🚀 Cloud & DevOps Engineer with 5+ years of experience designing, implementing, and optimizing highly available, secure, and scalable cloud-native platforms.

⚙️ Specialized in container orchestration, infrastructure automation, and CI/CD ecosystem design using Docker, Kubernetes (EKS/AKS), Terraform, GitHub Actions, Jenkins, ArgoCD, and GitOps methodologies.

☁️ Extensive hands-on expertise with AWS services including EC2, Lambda, S3, RDS, VPC, IAM, delivering resilient and cost-efficient enterprise solutions.
...
🔐 Advocate for cloud security, compliance, & reliability engineering, building automated delivery pipelines that accelerate innovation & maintain operational excellence.
...
| [🔗 Airlline Booking System](https://github.com/pre2jasi/Airline-Booking-System)          | A simple Java and Spring Boot Based application to demo a bank Application                                      |
| [🔗 Dockerized ECS Pipeline](https://github.com/pre2jasi/aws-projects)    | Containerized php backend deployed via Docker, ECR, ECS Fargate with ALB and Terraform                                |
...
| [🔗 Demo Banking App](https://github.com/pre2jasi/Java-Bank-Demo-Application)            | A simple Java and Spring Boot Based application to demo a bank Application                               |
